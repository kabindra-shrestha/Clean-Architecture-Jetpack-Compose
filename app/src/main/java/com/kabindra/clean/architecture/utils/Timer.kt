...
fun TimerExample() {
    ...
    Column(
        ...
        Spacer(modifier = androidx.compose.ui.Modifier.height(dimensionResource(id = com.intuit.sdp.R.dimen._16sdp)))

        // Start button
        ButtonNormal(text = "Start", onClick = { timerState.start() })

        Spacer(modifier = androidx.compose.ui.Modifier.height(dimensionResource(id = com.intuit.sdp.R.dimen._8sdp)))
